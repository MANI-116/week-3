...
exports.todoRouter.post('/todos', index_1.authenticateJwt, (req, res) => {
...
exports.todoRouter.get('/todos', index_1.authenticateJwt, (req, res) => {
    const userId = req.userId;
...
exports.todoRouter.patch('/todos/:todoId/done', index_1.authenticateJwt, (req, res) => {
